...
public class cringe extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mysound = MediaPlayer.create(cringe.this, R.raw.cringe);
        balikon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(cringe.this, MainActivity5.class);
